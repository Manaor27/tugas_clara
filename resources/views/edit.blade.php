        ...
        <div class="row">
          ...
          <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Form Edit Data Anggota Keluarga</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="POST" action="/update{{$rt->id}}{{$kk->id}}{{$data->id}}">
                  @csrf
                  @method('PUT')
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" class="form-control" placeholder="NIK No.KTP" name="nik" value="{{$data->nik}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Tempat Lahir</label>
                    <div class="col-sm-10">
                      <input type="string" class="form-control" placeholder="Tempat Lahir" name="tempat_lahir" value="{{$data->tempat_lahir}}">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" placeholder="Status Dalam Keluarga" name="status_keluarga" value="{{$data->status_keluarga}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-2" style="padding: 0em 2em">
                        <input class="form-check-input" type="radio" name="jekel" value="P" <?php if($data->jekel=="P"){echo 'checked';}?>>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-2" style="padding: 0em 2em">
                        <input class="form-check-input" type="radio" name="status_kawin" value="Kawin" <?php if($data->status_kawin=="Kawin"){echo 'checked';}?>>
                        <label class="form-check-label">Kawin</label>
                    </div>
                    <div class="col-sm-2" style="padding: 0em 2em">
                        <input class="form-check-input" type="radio" name="status_kawin" value="Belum Kawin" <?php if($data->status_kawin=="Belum Kawin"){echo 'checked';}?>>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name="goldar">
                          <option <?php if($data->goldar=='A'){echo 'selected';} ?>>A</option>
                          <option <?php if($data->goldar=='B'){echo 'selected';} ?>>B</option>
                          <option <?php if($data->goldar=='O'){echo 'selected';} ?>>O</option>
                          <option <?php if($data->goldar=='AB'){echo 'selected';} ?>>AB</option>
                        </select>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name="agama" value="{{$data->agama}}">
                          ...
                          <option <?php if($data->agama=='Khatolik'){echo 'selected';} ?>>Khatolik</option>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name="pendidikan" value="{{$data->pendidikan}}">
                          <option <?php if($data->pendidikan=='TK'){echo 'selected';} ?>>TK</option>
                          <option <?php if($data->pendidikan=='SD'){echo 'selected';} ?>>SD</option>
                          <option <?php if($data->pendidikan=='SMP'){echo 'selected';} ?>>SMP</option>
                          ...
                          <option <?php if($data->pendidikan=='S3'){echo 'selected';} ?>>S3</option>
                        </select>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" placeholder="Nama Ayah" name="nama_ayah" value="{{$data->nama_ayah}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Nama Ibu</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" placeholder="Nama Ibu" name="nama_ibu" value="{{$data->nama_ibu}}">
                    </div>
                  </div>
                  <div class="form-group row">
